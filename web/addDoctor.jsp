                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>APPointmentZ</strong> Add Doctors</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Use this form to add Doctors</h3>
                            		<p>Enter the information of Doctor to the system:</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="./addDoc" method="post" class="login-form">
									<div class="form-group">
			                    		<label class="sr-only" for="form-username"></label>
										<p>Doctor Name:</p>
			                        	<input type="text" name="doctor_name" placeholder="Doctor Name" class="form-username form-control" id="">
			                        </div>
			                    	<div class="form-group">
